...
"
" I am a Malaco.
" This colorscheme is a mix of Molokai with nice touches for html files
" from BadWolf theme by SteveLosh.

hi clear

set background=dark
let g:colors_name="malaco"
...
if &t_Co > 255
   ...
   " hi Constant        ctermfg=118               cterm=none
   ...
   hi Directory       ctermfg=222               cterm=none
   ...
   hi Keyword         ctermfg=196               cterm=none
   ...
   " HTML {{
   hi htmlTag               ctermfg=95          cterm=none
   hi htmlEndTag            ctermfg=95          cterm=none

   hi htmlTagName           ctermfg=173         cterm=bold
   hi htmlSpecialTagName    ctermfg=173         cterm=bold

   hi htmlArg         ctermfg=173               cterm=none
   hi htmlLink        ctermfg=245               cterm=underline
   " }}

   " CSS {{
   hi cssValueLength  ctermfg=137               cterm=bold
   hi cssColor        ctermfg=137               cterm=bold
   hi cssBraces       ctermfg=245               cterm=none
   hi cssIdentifier   ctermfg=214               cterm=bold
   hi cssClassName    ctermfg=214               cterm=none
   " }}
